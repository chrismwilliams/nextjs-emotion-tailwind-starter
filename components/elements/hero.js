  ...
  return (
    <StyledHero>
      <div className="hero-wrapper">
        ...
        <h2>
          I'm a Next JS starter pre-packed with Emotion and Tailwind CSS. I come
          with some cool modern features like code splitting, filesystem based
          routing, and statically generated and server-rendered React
          applications. Check out the source code{" "}
          <a
